#  Esta función se encarga de comparar un valor value con un criterio de comparación dado. 
# Si el valor es de tipo int, str o bool, simplemente se devuelve el valor. En caso contrario, 
# se verifica si el criterio existe como atributo en el objeto value y se retorna el valor correspondiente a ese criterio.
# Si el criterio no existe, se imprime un mensaje indicando que no se puede ordenar por ese criterio.
...
# Inserta un valor en la lista en la posición correcta según el criterio de ordenamiento especificado.
#  Si no se proporciona ningún criterio, se inserta el valor al final de la lista.
...
#Realiza una búsqueda binaria en la lista para encontrar la posición del valor buscado,
# utilizando el criterio de comparación especificado. Devuelve la posición del valor o None si no se encuentra.
    def search(self, search_value, criterio=None):
        position = None
        for i in range(self.size()):
            if criterio_comparacion(search_value, criterio) == criterio_comparacion(self.__elements[i].nombre, criterio):
                position = i
                break
        return position
...
#Elimina el valor especificado de la lista, utilizando el criterio de comparación dado. 
# Devuelve el valor eliminado o None si no se encuentra.
...
# Ordena la lista según el criterio de comparación especificado.
# Si no se proporciona ningún criterio, se imprime un mensaje indicando que no se puede ordenar por ese criterio.
...
# Reemplaza el valor especificado por uno nuevo en la lista, utilizando el criterio de comparación dado.
