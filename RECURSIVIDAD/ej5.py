...
def romano_a_decimal(numeros_romanos):
    valores_numeros_romanos = {'I': 1, 'V': 5, 'X': 10, 'L': 50, 'C': 100, 'D': 500, 'M': 1000} #diccionario de numeros romanos
    if len(numeros_romanos) == 0:
        return 0
    if len(numeros_romanos) == 1:
        return valores_numeros_romanos[numeros_romanos] #devuelve el valor del numero romano correspondiente
